...
def evaluation_model(model_name, model, param_grid, input_directory):
    """Performs the 5 models with the confusion matrices, ROC Curves, and Learning curves for validation and test sets"""
    ...
    x_train_val, x_test, y_train_val, y_test = train_test_split(x, y, test_size=0.2, stratify=y, random_state=40)
    ...
    plot_learning_curve(best_model, title, x_train_scaled, y_train, cv=5)
